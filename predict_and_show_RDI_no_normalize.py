...
train_or_test_data='test_no_normalize.npz'
test_data = np.load(os.path.join(processed_data_path, train_or_test_data))
test_labels = test_data['labels']
test_data = test_data['data']

model_path =os.path.join(current_path , "model/gesture_model_RDI_data_no_normalize.h5")
...
output_path=os.path.join(current_path, "test_output/predicted_labels_RDI_no_normalize.csv")
